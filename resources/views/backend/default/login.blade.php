...
<style type="text/css">
.login-page{
    background: url('/images/settings/bg.png') no-repeat center center fixed;/* daha sonra tekrarlaması için no-repeat*/
...
<div class="login-box">
  <div class="login-logo">
    <a style="font-weight:bold" href="{{route('nedmin.Login')}}"><b>SC</b>Yazılım</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="{{route('nedmin.Authenticate')}}" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" required name="email" placeholder="Kullanıcı Adı" value="{{old('email')}}">
