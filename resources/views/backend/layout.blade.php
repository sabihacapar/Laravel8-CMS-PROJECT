...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('nedmin.Index')}}" class="logo">
      ...
      <span class="logo-lg"><b>SC </b>BOOKS</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('nedmin.Index')}}"><i class="fa fa-link"></i> <span>Dasboard</span></a></li>
        <li><a href="{{route('blog.index')}}"><i class="fa fa-paper-plane"></i> <span>Gündemdeki Kitaplar</span></a></li>
        <li><a href="{{route('page.index')}}"><i class="fa fa-paper"></i> <span>Seri Kitaplar</span></a></li>
        <li><a href="{{route('slider.index')}}"><i class="fa fa-paper"></i> <span>Slider</span></a></li> 
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="#">SC Yazılım</a>.</strong> All rights reserved.
  </footer>
