...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="{{route('home.Index')}}">SC <b>BOOKS</b> </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('blog.Index')}}">Gündemdeki Kitaplar</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="/page/{{$slug}}">Seri Kitaplar</a>
          </li>
          <li class="nav-item">
